...
pub trait ChaumPedersenSigner<E: EngineBLS, H: FixedOutputReset + Default + Clone> {
...
pub trait ChaumPedersenVerifier<E: EngineBLS, H: FixedOutputReset + Default + Clone> {
...
impl<E: EngineBLS, H: FixedOutputReset + Default + Clone> ChaumPedersenSigner<E, H> for SecretKeyVT<E> {
    fn generate_cp_signature(&mut self, message: &Message) -> ChaumPedersenSignature<E> {
...
/// This should be implemented by public key
#[allow(non_snake_case)]
impl<E: EngineBLS, H: FixedOutputReset + Default + Clone> ChaumPedersenVerifier<E, H>
